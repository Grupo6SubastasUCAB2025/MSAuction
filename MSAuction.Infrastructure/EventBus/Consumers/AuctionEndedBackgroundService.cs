...
public class AuctionEndedBackgroundService : BackgroundService
{
    private readonly IMongoCollection<MongoAuction> _collection;
    private IModel? _channel;
    private IConnection? _connection;

    public AuctionEndedBackgroundService(IMongoClient mongoClient)
    {
        ...
        _channel.QueueDeclare(queue: "auction_ended_queue", durable: false, exclusive: false, autoDelete: false);
    }
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _channel.BasicConsume(queue: "auction_ended_queue", autoAck: true, consumer: consumer);
